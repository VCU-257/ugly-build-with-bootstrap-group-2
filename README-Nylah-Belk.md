...
- The HTML file I built is the finances.html file.
...
* **Components Used:** 
- Bootstrap Navbar (top and bottom)
- Bootstrap Container
- Bootstrap Grids
...
- I did not fully build the card grid with the multi-span elements as it would need scripting to be useful. The most challenging part of this assignment was positioning the breadcrumbs and limiting the navbars to either desktop or mobile.
